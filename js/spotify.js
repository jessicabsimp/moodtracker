...
function renderSpotifyRecentSessions(tracks) {
    ...
    // 1. Target Audio Pulse Bar UI Elements
    ...
    // 2. Update Left-Column Today Card Status Subtitle
    ...
    // 3. Populate Audio Pulse Bar with Dynamic Spotify Data
    if (tokenExists && tracks && tracks.length > 0) {
        const latestTrack = tracks[0]; // Most recent track
    ...
    // Optional legacy fallback renderer for dedicated subpage/modal lists
